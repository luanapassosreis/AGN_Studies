...
=============================================================================
Name: mpi_DE.py
Run: mpirun -n 4 python mpi_DE.py
Author: 
Date: 
=============================================================================
=============================================================================
...
N0 = 36               ## number of inital parents, N0 = 36
...
F = 0.5
cr = 0.7
parallel = False      ## parallel processing mode, parallel = True
...
for run in range(runs_rank):
    alh = de(N0, ObFunc, Cm, CM, Nc, it_max , F, cr)
