...
for alg in algs:
    ...
    filename_conv   = dir_save + "mpi_" + label + "_convsChiS_ITS.npy"    
    filename_sols   = dir_save + "mpi_" + label + "_sols_ITS.npy"    
    filename_time   = dir_save + "mpi_" + label + "_time_ITS.npy"
    ...
    print(alg+" merged conv array saved in: ", filename_conv)
    print(alg+" merged sols array saved in: ", filename_sols)
    print(alg+" merged time array saved in: ", filename_time)
